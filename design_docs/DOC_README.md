...
| [Line box model](2026-09-25_line_box_model_plan.md) | Plan, ruled 2026-09-25: build each line box per CSS 2.1 10.8 in genet-livery's line pass (a strut, each run's own half-leading, atoms by margin box, lines stacked from those heights) instead of correcting Parley's single line height afterwards. Found through Knot's tall inline-block sitting 2px into the line above. |
